...
(function () {
    ...
    var EXTRA_THEMES = [
        ...
        { num: 43, name: 'WONDER PLAINS', lt: 'Stebuklu pieva', bg: '#7EDBFF', tint: 0x10B981, menuColor: 0x10B981, icon: 'hill', decorSet: 'wonderplains', words: ['jump', 'green', 'block', 'water', 'coin', 'flag'], music: 'overworld', scene: 'WonderScene' },
        { num: 44, name: 'FLUFF-PUFF PEAKS', lt: 'Puku debesys', bg: '#EAF9FF', tint: 0xd9f7ff, menuColor: 0x77CFF2, icon: 'cloud', decorSet: 'fluffpuff', words: ['cloud', 'white', 'jump', 'sky', 'star', 'run'], music: 'overworld', scene: 'WonderScene' },
        { num: 45, name: 'BIOLUMINESCENT FOREST', lt: 'Svytintis miskas', bg: '#071827', tint: 0x2DD4BF, menuColor: 0x14B8A6, icon: 'hill', decorSet: 'bioforest', words: ['night', 'mushroom', 'jump', 'green', 'key', 'pot'], music: 'underground', scene: 'WonderScene' },
        { num: 46, name: 'PASTEL DEPTHS', lt: 'Pastelines gelmes', bg: '#A9E7FF', tint: 0x818CF8, menuColor: 0x818CF8, icon: 'cloud', decorSet: 'pasteldepths', words: ['water', 'swim', 'bubble', 'purple', 'coin', 'fish'], music: 'overworld', scene: 'WonderScene' },
        { num: 47, name: 'NEON UNDERGROUND', lt: 'Neoninis pozemis', bg: '#05030B', tint: 0xF472B6, menuColor: 0xC026D3, icon: 'tiles', decorSet: 'neonunderground', words: ['key', 'door', 'wall', 'up', 'down', 'run'], music: 'underground', scene: 'WonderScene' },
        { num: 48, name: 'ICE SLIDE', lt: 'Ledo slide', bg: '#DDF7FF', tint: 0x9BE7FF, menuColor: 0x67D6F7, icon: 'cloud', decorSet: 'iceslide', words: ['ice', 'slide', 'blue', 'snow', 'jump', 'flag'], music: 'overworld', scene: 'WonderScene' },
        { num: 49, name: 'WIND DUNES', lt: 'Vejo kopos', bg: '#FFDFA0', tint: 0xF6C56B, menuColor: 0xE5A53B, icon: 'hill', decorSet: 'winddunes', words: ['wind', 'sand', 'sun', 'jump', 'run', 'flag'], music: 'overworld', scene: 'WonderScene' },
        { num: 50, name: 'CLOCKWORK GEARS', lt: 'Krumpliaraciu fabrikas', bg: '#5A3A25', tint: 0xD9A441, menuColor: 0xB7791F, icon: 'tiles', decorSet: 'clockwork', words: ['gear', 'clock', 'jump', 'metal', 'coin', 'flag'], music: 'underground', scene: 'WonderScene' },
        { num: 51, name: 'MAGNET CAVES', lt: 'Magnetines olos', bg: '#130F1F', tint: 0x60A5FA, menuColor: 0x2563EB, icon: 'tiles', decorSet: 'magnetcaves', words: ['red', 'blue', 'metal', 'switch', 'cave', 'flag'], music: 'underground', scene: 'WonderScene' },
        { num: 52, name: 'MIRROR HALL', lt: 'Veidrodziu sale', bg: '#F2E8FF', tint: 0xF0ABFC, menuColor: 0xD946EF, icon: 'cloud', decorSet: 'mirrorhall', words: ['mirror', 'twin', 'left', 'right', 'jump', 'flag'], music: 'overworld', scene: 'WonderScene' }
    ];
